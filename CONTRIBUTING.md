...
6. After running building packer successfully, use
   `$GOPATH/src/github.com/idanya/packer/bin/packer` to build a machine and
   verify your changes work. For instance: `$GOPATH/src/github.com/idanya/packer/bin/packer build template.json`.
